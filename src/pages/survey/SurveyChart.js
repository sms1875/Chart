 ...
 */
const SurveyChart = ({ ChartItem, selectedAxes, annotationXValue, isAnnotationEnabled }) => {
  ...
  const chartOptions = useMemo(() => (
    getChartOptions(selectedAxes, axisConfig, annotationXValue.min, annotationXValue.max, isAnnotationEnabled, isDragDataRef)
